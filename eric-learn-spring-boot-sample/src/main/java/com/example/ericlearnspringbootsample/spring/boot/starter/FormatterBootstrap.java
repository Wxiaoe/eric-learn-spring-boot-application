package com.example.ericlearnspringbootsample.spring.boot.starter;

import com.example.ericlearnspringbootsample.spring.boot.autoconfigure.formatter.Formater;
